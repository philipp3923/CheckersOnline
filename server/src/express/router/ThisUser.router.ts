...
export default class ThisUserRouter extends AbstractRouter {
    ...
    constructor(path: string, app: Router,
        ...
        const passwordController = new PasswordController(tokenService, userService);
        ...
        this.router.patch("/password", (req, res, next) => passwordController.patch(req, res, next));
        this.router.patch("/email", (req, res, next) => emailController.patch(req, res, next));
        this.router.get("/email", (req, res, next) => emailController.get(req, res, next));
