...
export default class ExpressServer {
    ...
    constructor(private app: Express, private tokenService: TokenService, private guestService: GuestService, private userService: UserService, private accountService: AccountService, private gameService: GameService) {
        ...
        new AuthenticationRouter("/auth", this.app, tokenService, guestService, userService, accountService, decryptRefreshTokenMiddleware);
        new UserRouter("/user", this.app, tokenService, userService, accountService, gameService, decryptAccessTokenMiddleware, isUserParameterValidMiddleware, isThisUserMiddleware);
