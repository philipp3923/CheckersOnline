...
export class SocketService {
  ...
  public playMove(key: string, index: number) {
    this.emit('gameTurn', { key: key, index: index }, (res: any) =>
      console.log(res)
    );
  }
  ...
  public addFriendRequestListener(
    listener: (friendship: FriendshipModel) => void
  ) {
    this.addListener('friendRequest', listener);
  }

  public addFriendAcceptListener(
    listener: (friendship: FriendshipModel) => void
  ) {
    this.addListener('friendAccept', listener);
  }

  public addFriendDeleteListener(
    listener: (friendship: FriendshipModel) => void
  ) {
